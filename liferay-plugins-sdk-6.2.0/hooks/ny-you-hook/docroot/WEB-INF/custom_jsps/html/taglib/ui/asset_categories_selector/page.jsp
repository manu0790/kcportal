...
if (Validator.isNotNull(className)) {
	...
	for (AssetVocabulary vocabulary : vocabularies) {
		...
		boolean singleSelect = !vocabulary.isMultiValued();
		if(request.getAttribute("singleSelect")!= null){
			singleSelect = Boolean.valueOf((String)request.getAttribute("singleSelect")); //category selector will be a radio button
		}
			...
			new Liferay.AssetCategoriesSelector(
				{
					...
					curEntries: '<%=StringEscapeUtils.escapeJavaScript(StringEscapeUtils.unescapeHtml(categoryIdsTitles[1]))%>',
