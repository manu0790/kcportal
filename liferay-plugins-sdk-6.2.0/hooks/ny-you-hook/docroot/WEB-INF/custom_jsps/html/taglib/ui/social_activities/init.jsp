...
<%
List<SocialActivity> activities1 = (List<SocialActivity>)request.getAttribute("liferay-ui:social-activities:activities");
List<SocialActivity> activities=new ArrayList<SocialActivity>();

for(SocialActivity activitie:activities1){
	long LessonId=ClassNameLocalServiceUtil.getClassNameId("com.nyu.model.Lesson");
	if(activitie.getClassNameId()==LessonId){
