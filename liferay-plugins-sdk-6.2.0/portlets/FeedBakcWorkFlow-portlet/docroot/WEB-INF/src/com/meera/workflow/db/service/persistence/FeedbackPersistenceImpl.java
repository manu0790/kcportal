...
import com.meera.workflow.db.NoSuchFeedbackException;
...
public class FeedbackPersistenceImpl extends BasePersistenceImpl<Feedback>
	...
	@Override
	public Feedback updateImpl(com.meera.workflow.db.model.Feedback feedback)
		throws SystemException {
		feedback = toUnwrappedModel(feedback);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.meera.workflow.db.model.Feedback")));
