...
/**
 * Provides the local service interface for Lesson_Usergroups. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Allwins Rajaiah
 * @see Lesson_UsergroupsLocalServiceUtil
...
public interface Lesson_UsergroupsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Lesson_UsergroupsLocalServiceUtil} to access the lesson_ usergroups local service. Add custom service methods to {@link com.nyu.service.impl.Lesson_UsergroupsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
