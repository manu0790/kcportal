...
/**
 * Provides the local service interface for LessonObjectives. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Allwins Rajaiah
 * @see LessonObjectivesLocalServiceUtil
...
public interface LessonObjectivesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LessonObjectivesLocalServiceUtil} to access the lesson objectives local service. Add custom service methods to {@link com.nyu.service.impl.LessonObjectivesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
