...
/**
 * Provides the local service interface for Basno. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Allwins Rajaiah
 * @see BasnoLocalServiceUtil
...
public interface BasnoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BasnoLocalServiceUtil} to access the basno local service. Add custom service methods to {@link com.nyu.service.impl.BasnoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
