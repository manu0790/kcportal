...
/**
 * Provides the local service interface for UserGroupRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Allwins Rajaiah
 * @see UserGroupRequestLocalServiceUtil
...
public interface UserGroupRequestLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserGroupRequestLocalServiceUtil} to access the user group request local service. Add custom service methods to {@link com.nyu.service.impl.UserGroupRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
