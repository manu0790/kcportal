...
showDocumentURL.setParameter("checkMarkedAs","checkMarkedAs");
showDocumentURL.setParameter("fromTab",Constant.ARCHIVED_LESSONS);
				...
				<article class="lesson shadow">
					...
					<header>
					 <a href="<%=showDocumentURL%>&_<%=Constant.PORTLET_LESSON%>_lessonId={{lesson.lessonId}}">
						<h3> 
							<span class="status-icon status-img" >
				       			<img src="<%= Constant.COMMON_THEME_IMAGE_PATH + Constant.VENDOR_NAME + StringPool.SLASH %>inappropriat-flag.png" class="nyu-tooltip" data-title='<liferay-ui:message key="marked-inappropriate" />' onmouseover="tooltipOver(this)" onmouseleave="tooltipOut(this)"">
				       		</span>
