...
<div id="favouriteLessonsController" ng-controller="LessonsController"> 
	<h1> <img width="34px;" src="<%= Constant.COMMON_THEME_IMAGE_PATH + Constant.VENDOR_NAME + StringPool.SLASH %>favorite-icon.png">
	...
	<div class="filter-form row-fluid">
	   ...
	   <div class="row-fluid">
			...
			<div class="thumbnail-lessons span4" ng-repeat="lesson in filteredItems = (lessons | filter:categoryId | filter:tagId | limitTo:limit)" ng-class="($index % 3 == 0) ? 'no-margin clearfix' : ''"  style="position: relative" ng-cloak my-stuff-my-lessons-directive>
			<div class="my-flip">
				<div class="back">
					...
					<a href="<%=editUrl%>&_<%=Constant.PORTLET_CREATE_LESSON%>_lessonId={{lesson.lessonId}}">
				       <h3>
						<img class="thumb-dimension" 	ng-src="{{lesson.documentPath}}">	
							...
							<span style="padding-right: 20px;" class="text-overFlow">  {{lesson.lessonName}} </span>
						 </h3>
						 </a>
						</span> 
						<span ng-if=lesson.status!='draft'>
				 	...
				 	<div class="content" style="height:30px; padding: 0;"> 
