...
<%  request_portlet_Id = Constant.PORTLET_REQUEST_LESSON;
...
deleteRequestURL.setParameter(Constant.COMMON_STRING_CONSTANT_USER_GROUP_ID,String.valueOf(userGroupId));
...
<div id="allRequests" class="tab-pane">
	<div id="requestForInfo">
		<p ng-show="allJsonRequests.length==0"><liferay-ui:message key="no-requests-found" />.</p>
			<div ng-repeat="request in allJsonRequests | filter:tagId | offset: currentPage*itemsPerPage | filter:searchPageWise | limitTo: itemsPerPage">
