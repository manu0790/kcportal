...
<div id="popOverBodyCotent">
	...
	<!-- ============== TAB COMPONENT ==================== -->
	<div id="nyYouCreateGroupTab" class="clearfix ng-cloak">
		<!-- TAB LINKS -->
		...
		<div class="tab-content">
			<div id="groupType" class="tab-pane">
				...
				<footer class="text-center"> <a href="javascript:void(0);" class="btn btn-large group-close-popup"><liferay-ui:message key="cancel" /></a></footer>
			</div>
