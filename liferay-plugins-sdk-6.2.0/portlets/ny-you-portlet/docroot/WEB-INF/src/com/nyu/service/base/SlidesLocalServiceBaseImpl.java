...
import com.nyu.service.SlidesLocalService;
...
/**
 * Provides the base implementation for the slides local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.SlidesLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SlidesLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SlidesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.SlidesLocalServiceUtil} to access the slides local service.
	 */
	...
	@Override
	public Slides addSlides(Slides slides) throws SystemException {
		slides.setNew(true);

		return slidesPersistence.update(slides);
	}
	 ...
	 */
	@Override
	public Slides createSlides(long id) {
		return slidesPersistence.create(id);
	}
	...
	@Override
	public Slides deleteSlides(long id) throws PortalException, SystemException {
		return slidesPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Slides deleteSlides(Slides slides) throws SystemException {
		return slidesPersistence.remove(slides);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Slides.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return slidesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return slidesPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return slidesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return slidesPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Slides fetchSlides(long id) throws SystemException {
		return slidesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public Slides getSlides(long id) throws PortalException, SystemException {
		return slidesPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return slidesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Slides> getSlideses(int start, int end)
		throws SystemException {
		return slidesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSlidesesCount() throws SystemException {
		return slidesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Slides updateSlides(Slides slides) throws SystemException {
		return slidesPersistence.update(slides);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.Slides",
			slidesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.nyu.model.Slides");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = slidesPersistence.getDataSource();
	...
	private SlidesLocalServiceClpInvoker _clpInvoker = new SlidesLocalServiceClpInvoker();
}