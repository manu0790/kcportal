...
import com.nyu.service.BasnoLocalService;
...
/**
 * Provides the base implementation for the basno local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.BasnoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BasnoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BasnoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.BasnoLocalServiceUtil} to access the basno local service.
	 */
	...
	@Override
	public Basno addBasno(Basno basno) throws SystemException {
		basno.setNew(true);

		return basnoPersistence.update(basno);
	}
	 ...
	 */
	@Override
	public Basno createBasno(long badgeId) {
		return basnoPersistence.create(badgeId);
	}
	...
	@Override
	public Basno deleteBasno(long badgeId)
		throws PortalException, SystemException {
		return basnoPersistence.remove(badgeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Basno deleteBasno(Basno basno) throws SystemException {
		return basnoPersistence.remove(basno);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Basno.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return basnoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return basnoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return basnoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return basnoPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Basno fetchBasno(long badgeId) throws SystemException {
		return basnoPersistence.fetchByPrimaryKey(badgeId);
	}
	 ...
	 */
	@Override
	public Basno getBasno(long badgeId) throws PortalException, SystemException {
		return basnoPersistence.findByPrimaryKey(badgeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return basnoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Basno> getBasnos(int start, int end) throws SystemException {
		return basnoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBasnosCount() throws SystemException {
		return basnoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Basno updateBasno(Basno basno) throws SystemException {
		return basnoPersistence.update(basno);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.Basno",
			basnoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.nyu.model.Basno");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = basnoPersistence.getDataSource();
	...
	private BasnoLocalServiceClpInvoker _clpInvoker = new BasnoLocalServiceClpInvoker();
}