...
import com.nyu.service.DocumentSectionLocalService;
...
/**
 * Provides the base implementation for the document section local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.DocumentSectionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DocumentSectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentSectionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.DocumentSectionLocalServiceUtil} to access the document section local service.
	 */
	...
	@Override
	public DocumentSection addDocumentSection(DocumentSection documentSection)
		throws SystemException {
		documentSection.setNew(true);

		return documentSectionPersistence.update(documentSection);
	}
	 ...
	 */
	@Override
	public DocumentSection createDocumentSection(long id) {
		return documentSectionPersistence.create(id);
	}
	...
	@Override
	public DocumentSection deleteDocumentSection(long id)
		throws PortalException, SystemException {
		return documentSectionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocumentSection deleteDocumentSection(
		DocumentSection documentSection) throws SystemException {
		return documentSectionPersistence.remove(documentSection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentSection.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentSectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentSectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocumentSection fetchDocumentSection(long id)
		throws SystemException {
		return documentSectionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DocumentSection getDocumentSection(long id)
		throws PortalException, SystemException {
		return documentSectionPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return documentSectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocumentSection> getDocumentSections(int start, int end)
		throws SystemException {
		return documentSectionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDocumentSectionsCount() throws SystemException {
		return documentSectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocumentSection updateDocumentSection(
		DocumentSection documentSection) throws SystemException {
		return documentSectionPersistence.update(documentSection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.DocumentSection",
			documentSectionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.nyu.model.DocumentSection");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = documentSectionPersistence.getDataSource();
	...
	private DocumentSectionLocalServiceClpInvoker _clpInvoker = new DocumentSectionLocalServiceClpInvoker();
}