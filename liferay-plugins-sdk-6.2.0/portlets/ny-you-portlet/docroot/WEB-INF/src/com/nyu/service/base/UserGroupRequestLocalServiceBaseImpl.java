...
import com.nyu.service.UserGroupRequestLocalService;
...
/**
 * Provides the base implementation for the user group request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.UserGroupRequestLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class UserGroupRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserGroupRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.UserGroupRequestLocalServiceUtil} to access the user group request local service.
	 */
	...
	@Override
	public UserGroupRequest addUserGroupRequest(
		UserGroupRequest userGroupRequest) throws SystemException {
		userGroupRequest.setNew(true);

		return userGroupRequestPersistence.update(userGroupRequest);
	}
	 ...
	 */
	@Override
	public UserGroupRequest createUserGroupRequest(long id) {
		return userGroupRequestPersistence.create(id);
	}
	...
	@Override
	public UserGroupRequest deleteUserGroupRequest(long id)
		throws PortalException, SystemException {
		return userGroupRequestPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserGroupRequest deleteUserGroupRequest(
		UserGroupRequest userGroupRequest) throws SystemException {
		return userGroupRequestPersistence.remove(userGroupRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserGroupRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userGroupRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userGroupRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserGroupRequest fetchUserGroupRequest(long id)
		throws SystemException {
		return userGroupRequestPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public UserGroupRequest getUserGroupRequest(long id)
		throws PortalException, SystemException {
		return userGroupRequestPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userGroupRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserGroupRequest> getUserGroupRequests(int start, int end)
		throws SystemException {
		return userGroupRequestPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserGroupRequestsCount() throws SystemException {
		return userGroupRequestPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserGroupRequest updateUserGroupRequest(
		UserGroupRequest userGroupRequest) throws SystemException {
		return userGroupRequestPersistence.update(userGroupRequest);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.UserGroupRequest",
			userGroupRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.nyu.model.UserGroupRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userGroupRequestPersistence.getDataSource();
	...
	private UserGroupRequestLocalServiceClpInvoker _clpInvoker = new UserGroupRequestLocalServiceClpInvoker();
}