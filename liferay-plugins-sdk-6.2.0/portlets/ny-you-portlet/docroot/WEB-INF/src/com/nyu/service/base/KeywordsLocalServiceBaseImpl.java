...
import com.nyu.service.KeywordsLocalService;
...
/**
 * Provides the base implementation for the keywords local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.KeywordsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class KeywordsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements KeywordsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.KeywordsLocalServiceUtil} to access the keywords local service.
	 */
	...
	@Override
	public Keywords addKeywords(Keywords keywords) throws SystemException {
		keywords.setNew(true);

		return keywordsPersistence.update(keywords);
	}
	 ...
	 */
	@Override
	public Keywords createKeywords(long id) {
		return keywordsPersistence.create(id);
	}
	...
	@Override
	public Keywords deleteKeywords(long id)
		throws PortalException, SystemException {
		return keywordsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Keywords deleteKeywords(Keywords keywords) throws SystemException {
		return keywordsPersistence.remove(keywords);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Keywords.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return keywordsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return keywordsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return keywordsPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return keywordsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Keywords fetchKeywords(long id) throws SystemException {
		return keywordsPersistence.fetchByPrimaryKey(id);
	}
	...
	public Keywords getKeywords(long id)
		throws PortalException, SystemException {
		return keywordsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return keywordsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Keywords> getKeywordses(int start, int end)
		throws SystemException {
		return keywordsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKeywordsesCount() throws SystemException {
		return keywordsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Keywords updateKeywords(Keywords keywords) throws SystemException {
		return keywordsPersistence.update(keywords);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.Keywords",
			keywordsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.nyu.model.Keywords");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = keywordsPersistence.getDataSource();
	...
	private KeywordsLocalServiceClpInvoker _clpInvoker = new KeywordsLocalServiceClpInvoker();
}