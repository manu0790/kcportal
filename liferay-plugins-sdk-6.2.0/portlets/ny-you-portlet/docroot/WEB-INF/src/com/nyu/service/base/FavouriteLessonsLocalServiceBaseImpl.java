...
import com.nyu.service.FavouriteLessonsLocalService;
...
/**
 * Provides the base implementation for the favourite lessons local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nyu.service.impl.FavouriteLessonsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FavouriteLessonsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FavouriteLessonsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nyu.service.FavouriteLessonsLocalServiceUtil} to access the favourite lessons local service.
	 */
	...
	@Override
	public FavouriteLessons addFavouriteLessons(
		FavouriteLessons favouriteLessons) throws SystemException {
		favouriteLessons.setNew(true);

		return favouriteLessonsPersistence.update(favouriteLessons);
	}
	 ...
	 */
	@Override
	public FavouriteLessons createFavouriteLessons(
		FavouriteLessonsPK favouriteLessonsPK) {
		return favouriteLessonsPersistence.create(favouriteLessonsPK);
	}
	...
	@Override
	public FavouriteLessons deleteFavouriteLessons(
		FavouriteLessonsPK favouriteLessonsPK)
		throws PortalException, SystemException {
		return favouriteLessonsPersistence.remove(favouriteLessonsPK);
	}
	...
	public FavouriteLessons deleteFavouriteLessons(
		FavouriteLessons favouriteLessons) throws SystemException {
		return favouriteLessonsPersistence.remove(favouriteLessons);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FavouriteLessons.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return favouriteLessonsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return favouriteLessonsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FavouriteLessons fetchFavouriteLessons(
		FavouriteLessonsPK favouriteLessonsPK) throws SystemException {
		return favouriteLessonsPersistence.fetchByPrimaryKey(favouriteLessonsPK);
	}
	 ...
	 */
	@Override
	public FavouriteLessons getFavouriteLessons(
		FavouriteLessonsPK favouriteLessonsPK)
		throws PortalException, SystemException {
		return favouriteLessonsPersistence.findByPrimaryKey(favouriteLessonsPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return favouriteLessonsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FavouriteLessons> getFavouriteLessonses(int start, int end)
		throws SystemException {
		return favouriteLessonsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFavouriteLessonsesCount() throws SystemException {
		return favouriteLessonsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FavouriteLessons updateFavouriteLessons(
		FavouriteLessons favouriteLessons) throws SystemException {
		return favouriteLessonsPersistence.update(favouriteLessons);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.nyu.model.FavouriteLessons",
			favouriteLessonsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.nyu.model.FavouriteLessons");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = favouriteLessonsPersistence.getDataSource();
	...
	private FavouriteLessonsLocalServiceClpInvoker _clpInvoker = new FavouriteLessonsLocalServiceClpInvoker();
}