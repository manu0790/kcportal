...
public class FeedbackWrapper implements Feedback, ModelWrapper<Feedback> {
	...
	*/
	...
	@Override
	public int compareTo(com.service.feedback.model.Feedback feedback) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.service.feedback.model.Feedback> toCacheModel() {
		return _feedback.toCacheModel();
	}

	@Override
	public com.service.feedback.model.Feedback toEscapedModel() {
		return new FeedbackWrapper(_feedback.toEscapedModel());
	}

	@Override
	public com.service.feedback.model.Feedback toUnescapedModel() {
