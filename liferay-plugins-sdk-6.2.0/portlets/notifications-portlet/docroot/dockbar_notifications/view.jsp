		...
		<div class="dockbar-user-notifications-container">
			<ul class="dropdown-menu pull-right user-notifications-list">
				<div class="non-actionable ">
					 <div class="user-notifications-header clearfix">
						...
						<span style="padding: 5px;"><strong>Notifications: </strong></span>
						
					</div>
 
					<div class="user-notifications scroll-overFlow "></div>
				</div>
				 ...
				 <div class="actionable">
					...
					<div class="user-notifications scroll-overFlow hide "></div>
				</div> 
			</ul>
		</div>
			...
			var nonActionableNotificationsList = new Liferay.NotificationsList(
				{
					...
					delta: <%= unreadUserNotificationsCount %>,
					fullView: <%= false %>,
