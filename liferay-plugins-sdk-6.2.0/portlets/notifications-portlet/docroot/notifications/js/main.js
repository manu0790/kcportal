					...
					_bindMarkAsRead: function() {
						...
						if (notificationsNode) {
							notificationsNode.delegate(
								...
								'.user-notification .mark-as-read,.user-notification .button-click'
							);
						}
					},
						...
						if (notificationsNode) {
							notificationsNode.delegate(
								...
								function(event) {
									...
									if (target.hasClass('.mark-as-read') ||target.hasClass('.button-click') || target.ancestor('.mark-as-read') || (target._node.tagName == 'A')) {
										return;
									}
